...
namespace Query1
{
    ...
    {
      public static IEnumerable<IObservable<CurrentRunningData>> computeCurrentRunningData(IEnumerable<IObservable<PlayerData>> inp)
      {
        return inp.Select((IObservable<PlayerData> playerStream, int index) => {
      ...
      private struct Aggregate
        ...
        public static IEnumerable<IObservable<CurrentRunningData>> CurrentRunningAnalysis(this IEnumerable<IObservable<PlayerData>> src)
        {
...
/*  public static class CurrentRunningAnalysisQuery
  {
    public static IList<IObservable<CurrentRunningData>> computeCurrentRunningData(IEnumerable<IObservable<PlayerData>> inp)
    {
